...
def ensure_box_tables():
    with sqlite3.connect(DB) as con:
        ...
        # V10.81: niveaux personnels de la Salle des trophées (Great Hall), importés depuis PlayerArenaModel.dat.
    ...
    if cfg:
        ...
        if 1 <= level <= len(curve):
            ...
            for node_id in node_ids:
                ...
                # V10.81: awake_nodes.json currently mislabels some node bonuses as ManaGeneration.
...
</style></head><body><header><h1>🧪 Smishie's Lab</h1><div class=muted>V10.81 — Salle des trophées + reliques corrigées</div></header>
...
if __name__=='__main__':
    print("Smishie's Lab V10.81 — Salle des trophées + reliques corrigées — http://127.0.0.1:8501")
