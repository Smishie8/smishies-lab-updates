...
</style></head><body><header><h1>🧪 Smishie's Lab</h1><div class=muted>V10.70 — Correctif interface StaticData</div></header>
...
if __name__=='__main__':
    print("Smishie's Lab V10.70 — Correctif interface StaticData — http://127.0.0.1:8501")
