...
def support_buff_schedule(name, duration=120, adds_mode='none', boss_element='Neutre', support_mode='real'):
    ...
    if sm in ('base','base_stats','native'):
    ...
    elif sm in ('best','max','normalized'):
...
<div class=controls><div class=control><label>Preset support</label><select id=bestSupportMode><option value=real>Ma box</option><option value=base>Stats de base</option><option value=max>Max support</option></select></div></div><div class=note id=bestSupportModeNote>Ma box : vraie fiche importée de chaque support.</div>
