...
</style></head><body><header><h1>🧪 Smishie's Lab</h1><div class=muted>V10.89 — Import de box simplifié</div></header>
...
async function importBoxOneClick(){
 ...
 try{
  ...
  gameImportStatus.textContent=`✅ Box importée : ${x.imported||0} exemplaires · ${x.mapped||0} héros identifiés · ${x.relics_imported||0} reliques · ${x.hall_bonuses_imported||0} bonus de Salle des trophées · ${x.profiles_updated||0} profils mis à jour.`;
