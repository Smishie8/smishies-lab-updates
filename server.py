    ...
    try:
        ...
        for line in STATIC_1302_HERO_ROWS.splitlines():
            ...
            chars[str(config_id)]={'name':name,'gdid':int(gdid),'code':code,'soul_sign':int(soul),
                ...
                # CharacterConfig base stats validated in-game: PRE 0 / RES 10.
...
</style></head><body><header><h1>🧪 Smishie's Lab</h1><div class=muted>V10.99 — base éveil corrigée</div></header>
...
if __name__=='__main__':
    print("Smishie's Lab V10.99 — base éveil corrigée — http://127.0.0.1:8501")
