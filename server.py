...
</style></head><body><header><h1>🧪 Smishie's Lab</h1><div class=muted>V10.97 — correction éveil secondaire</div></header>
...
if __name__=='__main__':
    print("Smishie's Lab V10.97 — correction éveil secondaire — http://127.0.0.1:8501")
