...
</style></head><body><header><h1>🧪 Smishie's Lab</h1><div class=muted>V10.66 — Correctif interface et progression exacte</div></header>
...
if __name__=='__main__':
    print("Smishie's Lab V10.66 — Correctif interface et progression exacte — http://127.0.0.1:8501")
