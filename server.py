...
</style></head><body><header><h1>🧪 Smishie's Lab</h1><div class=muted>V10.87 — Recovery Sarienne + profils box actualisés</div></header>
...
if __name__=='__main__':
    print("Smishie's Lab V10.87 — Recovery Sarienne + profils box actualisés — http://127.0.0.1:8501")
